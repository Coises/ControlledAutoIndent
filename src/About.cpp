        ...
        case IDC_ABOUT_HELP:
            {
                ...
                path += L"\\ControlledAutoIndent\\help.htm";
        ...
        case IDC_ABOUT_MORE:
            {
                ...
                std::wstring path(n, 0);
                SendMessage(plugin.nppData._nppHandle, NPPM_GETPLUGINHOMEPATH, n + 1, reinterpret_cast<LPARAM>(path.data()));
                std::wstring changes = path + L"\\ControlledAutoIndent\\CHANGELOG.md";
                ...
                std::wstring license = path + L"\\ControlledAutoIndent\\LICENSE.txt";
                ...
                std::wstring readme = path + L"\\ControlledAutoIndent\\README.md";
